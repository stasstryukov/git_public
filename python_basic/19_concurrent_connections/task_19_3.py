...
commands = {
    "192.168.1.103": "sh run | s ^router ospf",
    "192.168.1.101": "sh ip int br",
...
def send_command_to_devices(devices,commands_dict,filename, limit):
	...
	with ThreadPoolExecutor(max_workers=limit) as executor:
		for device in devices:
			future = executor.submit(send_show, device, commands_dict[device['host']])
...
if __name__ == "__main__":
	...
	send_command_to_devices(devices, commands, "result.txt", 2)
