...
device = input('Выберите имя устройства: ')
parametrs = list(london_co[device].keys())
parametrs = ','.join(parametrs)
parametr = input('Введите имя параметра(' + parametrs + '): ' )
parametr = parametr.lower()
parametr = london_co[device].get(parametr,'Такого параметра нет')
print(parametr)
