...
$ python task_3_2a.py --help
Usage: task_3_2a.py [OPTIONS] COMMAND IP_LIST...
...
$ python task_3_2a.py "sh clock" 192.168.100.1 192.168.100.2 -u cisco -p cisco -s cisco
['sh clock\r\n*07:38:07.767 UTC Fri Sep 11 2020\r\nR1#',
 'sh clock\r\n*07:38:07.813 UTC Fri Sep 11 2020\r\nR2#']

$ python task_3_2a.py "sh clock" 192.168.100.1 192.168.100.2 -u cisco
Password:
Secret:
['sh clock\r\n*07:38:07.767 UTC Fri Sep 11 2020\r\nR1#',
 'sh clock\r\n*07:38:07.813 UTC Fri Sep 11 2020\r\nR2#']

$ python task_3_2a.py "sh clock" 192.168.100.1
Username: cisco
Password:
Secret:
['sh clock\r\n*07:47:48.959 UTC Fri Sep 11 2020\r\nR1#']

$ python task_3_2a.py "sh clock" 192.168.100.1 192.168.100.2 -p cisco -s cisco
Username: cisco
...
def cli(command,ip_list,username,password,threads):
    devices = []
    for ip in ip_list:
        device = {}
