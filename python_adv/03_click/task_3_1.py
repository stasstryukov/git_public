...
$ python task_3_1.py --help
Usage: task_3_1.py [OPTIONS] CDP_FILENAMES...
...
$ python task_3_1.py sh_cdp_n_sw1.txt sh_cdp_n_r1.txt -o result.csv
$ python task_3_1.py sh_cdp_n_* -o result.csv
$ python task_3_1.py sh_cdp_n_r[1-4]* -o result.csv
