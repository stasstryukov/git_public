...
$ python task_3_2.py --help
Usage: task_3_2.py [OPTIONS] COMMAND
...
$ python task_3_2.py "sh ip int br" -y devices.yaml
$ python task_3_2.py "sh ip int br" -y devices.yaml -t 1

$ python task_3_2.py "sh ip int br" -y devices.yaml -t 20
Usage: task_3_2.py [OPTIONS] COMMAND
Try 'task_3_2.py --help' for help.
...
@click.option("--yaml_params","-y",type=click.File('rt'))
@click.option("--threads","-t",type=click.IntRange(1, 10), default=5, show_default=True)
